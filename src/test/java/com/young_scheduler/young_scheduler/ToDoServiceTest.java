...
public class ToDoServiceTest {
    ...
    void testSaveToDo() {
        ...
        assertEquals(toDoDTO.getDescription(), savedToDo.getDiscription(), "설명이 일치해야 합니다.");
    }
    ...
    void testUpdateToDo() {
        ...
        assertEquals(updateDTO.getDescription(), updatedToDo.getDiscription(), "Description should be updated");
    ...
    void testGetToDoById() {
        ...
        assertEquals(existingToDo.getDiscription(), foundToDo.getDiscription(), "Description should match");
    }
